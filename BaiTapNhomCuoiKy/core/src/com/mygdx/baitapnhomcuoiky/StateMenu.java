...
public class StateMenu extends State {
    ...
    public StateMenu(FreegemasReprogrammed freegemas) {
        super(freegemas);
    ...
    public void load() {
        ...
        // Load fonts
        _fontMenu = FreegemasReprogrammed.getPlatformResolver().loadFont("data/menuFont.fnt", "data/menu.ttf", 60);
    ...
    public void assignResources() {
        ...
        _menuStart = new Vector2((FreegemasReprogrammed.VIRTUAL_WIDTH - maxWidth) / 2, 390);
        _menuGap = 100;
    ...
    public void render () {
        ...
        if (_state == State.Loading) {
            ...
            _fontLoading.draw(batch,
                    loading,
                    (FreegemasReprogrammed.VIRTUAL_WIDTH - _layout.width) / 2,
                    (FreegemasReprogrammed.VIRTUAL_HEIGHT - _layout.height) / 2);
        ...
        for (int i = 0; i < numOptions; ++i) {
            ...
            _fontMenu.draw(batch, _options.get(i).getFirst(), (FreegemasReprogrammed.VIRTUAL_WIDTH - _layout.width) / 2, _menuStart.y + i * _menuGap + 4);
            _fontMenu.setColor(1.0f, 1.0f, 1.0f, 1.0f);
            _fontMenu.draw(batch, _options.get(i).getFirst(), (FreegemasReprogrammed.VIRTUAL_WIDTH - _layout.width) / 2, _menuStart.y + i * _menuGap);
        }
        ...
        if (_readyToChange) {
            batch.draw(_imgHighlight,
                    (FreegemasReprogrammed.VIRTUAL_WIDTH - _imgHighlight.getRegionWidth()) / 2,
    ...
    public boolean touchDown(int arg0, int arg1, int arg2, int arg3) {
        ...
        if (arg3 == 0) {
            ...
            if (currentOption > 1 && Gdx.app.getType() == Application.ApplicationType.WebGL) {
                currentOption = 0;
            }
