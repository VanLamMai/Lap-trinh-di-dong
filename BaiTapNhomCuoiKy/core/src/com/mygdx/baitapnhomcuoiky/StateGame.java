...
public class StateGame extends State{
    ...
    public StateGame(FreegemasReprogrammed freegemas) {
        super(freegemas);
    ...
    public void load() {
        ...
        _fontTime = FreegemasReprogrammed.getPlatformResolver().loadFont("data/timeFont.fnt", "data/lcd.ttf", 100);
        _fontScore = FreegemasReprogrammed.getPlatformResolver().loadFont("data/scoreFont.fnt", "data/lcd.ttf", 70);
        _fontTotalScore = FreegemasReprogrammed.getPlatformResolver().loadFont("data/scoreFont.fnt", "data/lcd.ttf", 70);
        _fontText = FreegemasReprogrammed.getPlatformResolver().loadFont("data/normalFont.fnt", "data/normal.ttf", 45);
