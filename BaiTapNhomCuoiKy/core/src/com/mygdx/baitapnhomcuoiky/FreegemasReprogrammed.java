...
public class FreegemasReprogrammed extends ApplicationAdapter {
	//Based on Freegemas libGDX by Siondream on GitHub,
	//in turn based on Freegemas by JoseTomasTocino,
	//reprogrammed by Bui Huy Quang.
	//This game is made with libGDX engine
